...
angular.module('app.controllers')
 ...
 $scope.addSubsistema = function() {
      $http.post('/api/subsistemas/'+idproyecto, { nombre: $scope.nombre , sigla : $scope.sigla , valor : $scope.valor, descripcioncorta : $scope.descripcioncorta, descripcionlarga : $scope.descripcionlarga, modulo1 : $scope.modulo1, modulo2 : $scope.modulo2, modulo3 : $scope.modulo3}).success(function(data, status) {
          $scope.status = status;
          $scope.data = data;
          console.log($scope);
