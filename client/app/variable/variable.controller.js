...
angular.module('app.controllers')
  .controller('VariableCtrl', function ($scope,$http,toaster, listavariables, variablesFactory) {
    ...
    */
    $scope.addVariable = function() {
      ...
      $http.post('/api/variables', { nombre: $scope.nombre , sigla : $scope.sigla , descripcioncorta : $scope.descripcioncorta, descripcionlarga : $scope.descripcionlarga, funcion: $scope.funcion, sujeto: $scope.sujeto, verbo: $scope.verbo, predicado: $scope.predicado, v1: $scope.v1 , v2: $scope.v2 , v3: $scope.v3, v4: $scope.v4,v5: $scope.v5,v6: $scope.v6,v7: $scope.v7,v8: $scope.v8,v9: $scope.v9, com1: $scope.com1 , com2: $scope.com2 , com3: $scope.com3, com4: $scope.com4,com5: $scope.com5,com6: $scope.com6,com7: $scope.com7,com8: $scope.com8,com9: $scope.com9}).success(function(data, status) {
          $scope.status = status;
          $scope.data = data;
          console.log($scope);
