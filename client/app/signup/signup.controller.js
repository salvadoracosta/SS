  ...
  .controller('SignupCtrl', function ($scope,$http) {
    ...
    */
    $scope.addUsuario = function() {
      $http.post('/api/usuarios', { nombre: $scope.name , correo : $scope.email , password : $scope.password, telefono : $scope.tel, institucion : $scope.institucion}).success(function(data, status) {
          $scope.status = status;
          $scope.data = data;
          console.log($scope);
